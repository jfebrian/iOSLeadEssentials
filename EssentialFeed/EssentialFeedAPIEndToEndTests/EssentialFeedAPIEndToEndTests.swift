...
//
//  Created by Joanda Febrian on 03/12/22.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResults(file: StaticString = #file, line: UInt = #line) -> Result<[FeedImage], Error>? {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        ...
        _ = loader.loadImageData(from: feedTestServerURL.appendingPathComponent("73A7F70C-75DA-4C2E-B5A3-EED40DC53AA6/image")) { result in
